...
node_modules/
        ...
        try:
            # Change to project directory if valid
            original_cwd = os.getcwd()
            if project_path and os.path.exists(project_path):
                os.chdir(project_path)
                ui.debug(f"Changed to project directory: {project_path}", "Claude SDK")
            else:
                ui.warning(f"Project path invalid or not found: {project_path}", "Claude SDK")
                # Continue execution in current directory if project path is invalid
            ...
            try:
                ...
                try:
                    ...
                    ui.debug(f"Failed to restore original directory: {e}", "Claude SDK")
